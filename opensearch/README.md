...
| <a name="input_password"></a> [password](#input\_password) | Main user's username, which is stored in the Amazon OpenSearch Service domain's internal database. Only specify if internal\_user\_database\_enabled is set to true | `string` | `""` | no |
